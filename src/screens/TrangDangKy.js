              ...
              <form action method="post">
                <div className="card">
                  ...
                  <div className="card-footer text-muted">
                    <button style={{width: '100%', backgroundColor: 'skyblue', padding: '5px 20px', borderRadius: '20px', MozBorderRadius: '20px', WebkitBorderRadius: '20px'}} className="btn btn-success">Đăng ký</button>
                  </div>
                </div>
              </form>
            </div>
